 ...
 * @property {string} name Intitulé de la recette,
 * @property {number} servings Indéfini
 * @property {Array<Ingredient>} ingredients Tableau contenant des objets contenant des propriétés contenant les détails
 * @property {number} time Nombre de minutes de préparation de la recette
 * @property {string} description Texte contenant les instructions de préparation de la recette
 * @property {string} appliance Chaine de caractère de l'appareil utilisé pour la cuisson
 * @property {Array<string>} ustensils Tableau contenant les ustensiles utilisés pour la préparation de la recette
 */

/**
 * @typedef {Object} Ingredient Objet descriptif d'un ingrédient
...
/**
 * @class Data
 * @classdesc Permet de stocker, toutes les données utilisées par les différents modules et scripts
 * @hideconstructor
 */
export class Data {
    /** @type {Array<Recipe>} */
    ...
    /**
     * @property {Object} currentTags Liste des tags qui ont été ajoutées par l'interface de recherche
     * @property {Array<string>} currentTags.ingredients Contient tous les tags (ingrédients) de recherche
     * @property {Array<string>} currentTags.equipments Contient tous les tags (équipements) de recherche
     * @property {Array<string>} currentTags.ustensils Contient tous les tags (ustensiles) de recherche
     */
    static currentTags = {
        ingredients: [],
        equipments: [],
     ...
     * @property {HTMLElement} dropdownLists.ingredients Contient le bouton des ingrédients
     * @property {HTMLElement} dropdownLists.equipments Contient le bouton des équipements
     * @property {HTMLElement} dropdownLists.ustensils Contient le bouton des ustensiles
     */
     ...
     * @returns {Array<Recipe>} Retourne les 50 recettes existantes
     */
     ...
     * @returns {{name: string, time: number, description: string, ingredients: Array<Ingredient>}} Objet avec les propriétés : name, time, description, ingredients
     */
